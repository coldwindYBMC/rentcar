	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs"
				href="/aboutHui.shtml">汽车租赁管理系统</a> <a
				class="logo navbar-logo-m f-l mr-10 visible-xs"
				href="/aboutHui.shtml">ddz</a> <span
				class="logo navbar-slogan f-l mr-10 hidden-xs">ddz</span> <a
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover"><a href="#"
					class="dropDown_A">${sessionScope.user.fullname} <i class="Hui-iconfont">&#xe6d5;</i></a>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="/html/welcome.html">我的桌面</span>
					<em></em></li>
			</ul>
		</div>
